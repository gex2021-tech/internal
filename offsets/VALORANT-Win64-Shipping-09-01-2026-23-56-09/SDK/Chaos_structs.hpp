...
public:
	...
	enum class EEClusterUnionMethod                   ClusterUnionConnectionType;
...
public:
	...
	TArray<struct FSolverCollisionData>               Collisions;
	TArray<struct FSolverBreakingData>                Breakings;
	TSet<uint8[0x0] /**/>                             Trailings;
	float                                             Timestamp;
	uint8                                             Pad_0[0x0004];
};
...
{
public:
	TArray<struct FRecordedFrame>                     Records;
};
